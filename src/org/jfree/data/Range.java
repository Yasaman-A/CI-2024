...
public strictfp class Range implements Serializable {
     ...
     * 
     * @return A range which spans over the input range, and has been expanded to
     ...
     * which crosses the zero mark after shifting
    ...
    public static Range shift(Range base, double delta,
        ...
        if (allowZeroCrossing) {
            ...
            return new Range(shiftWithNoZeroCrossing(base.getLowerBound(),
                    delta),
                    shiftWithNoZeroCrossing(base.getUpperBound(),
                            delta));
        }
    }
